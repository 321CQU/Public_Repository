...
class BookInfo(BaseModel):
    ...
    图书馆书籍相关信息
    """
    id: Optional[int] = Field(default=None, title="书籍id")
    """书籍id"""
    ...
    """借出时间"""
    should_return_time: Optional[date] = Field(default=None, title="应归还日期")
    """应归还日期"""
    is_return: bool = Field(title="是否被归还")
    """是否被归还"""
    return_time: Optional[date] = Field(default=None, title="归还时间")
    """归还时间"""
    ...
    model_config = ConfigDict(title="图书馆书籍相关信息")
